package com.example.simple_soul.weixinchat.emotionkeyboardview;
...
public class EmotionKeyboard {
		...
		private View emotionButton, keyboard;
	     ...
	     * @return
	     */
	    public EmotionKeyboard bindToEmotionButton(final View emotionButton, final View keyboard) {
	    ...
	    private int getSupportSoftInputHeight() {
	        ...
	        if (softInputHeight < 0) {
				Log.w("main", "EmotionKeyboard--Warning: value of softInputHeight is below zero!");
	        }
	        //存一份到本地
	        if (softInputHeight > 0) {
